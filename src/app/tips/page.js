          ...
          <div className="flex flex-col gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[rgb(2,126,197)] focus:border-[rgb(2,126,197)] outline-none"
              />
            </div>
          ...
          {filteredTips.map((tip, index) => (
            <div key={index} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-start justify-between mb-4">
                <div className="w-12 h-12 bg-[rgb(2,126,197)] rounded-lg flex items-center justify-center mr-4">
                  <tip.icon className="text-white text-xl" />
                </div>
                <div className="flex flex-col items-end">
                  <span className="text-xs font-medium text-[rgb(2,126,197)] bg-[rgb(2,126,197)]/10 px-2 py-1 rounded-full mb-2">
                    {tip.category}
                  </span>
                  <span className={`text-xs font-medium px-2 py-1 rounded-full ${getDifficultyColor(tip.difficulty)}`}>
                    {tip.difficulty}
                  </span>
                </div>
              </div>
