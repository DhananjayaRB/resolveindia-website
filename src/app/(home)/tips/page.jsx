        ...
        <div className="bg-white rounded-lg shadow-lg p-4 mb-6">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="flex flex-wrap gap-1">
                <span className="text-xs font-medium text-gray-700 mr-2">Difficulty:</span>
            ...
            <div key={index} className="bg-white rounded-lg shadow-lg p-4 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex flex-col items-end">
                  <span className="text-xs font-medium text-[rgb(2,126,197)] bg-[rgb(2,126,197)]/10 px-1 py-0.5 rounded-full mb-1">
                    {tip.category}
                  </span>
                  <span className={`text-xs font-medium px-1 py-0.5 rounded-full ${getDifficultyColor(tip.difficulty)}`}>
                    {tip.difficulty}
                  </span>
                </div>
              </div>
