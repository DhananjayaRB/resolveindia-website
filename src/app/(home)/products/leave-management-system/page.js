        ...
        <main>
            ...
            <section className="py-5 ">
                <div className="container flex justify-center">
                    <Image src="/assets/leave/Single-Leave.png" alt="Leave Application" width={1000} height={1000} />
                </div>
            </section>
                        ...
                        {statisticsData.map((stat) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Bottom Curve */}
                                    <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-4 h-2 bg-transparent border-t-10 border-white rounded-t-full"></div>
            ...
            <section className="relative min-h-screen py-20 overflow-hidden">
                ...
                <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-center">
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-6 w-full max-w-7xl">
            ...
            <section className="relative py-20 overflow-hidden">
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-b from-blue-400 to-blue-900 opacity-90"></div>
                </div>
                    ...
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <div className="relative">
                            ...
                            <button 
                                ...
                                className="absolute left-4 lg:left-8 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-80 hover:bg-opacity-100 p-3 rounded-full transition-all duration-300 group shadow-lg z-20"
                                aria-label="Previous testimonial"
                            >
                                <svg className="w-6 h-6 text-blue-800 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button 
                                ...
                                className="absolute right-4 lg:right-8 top-1/2 transform -translate-y-1/2 bg-white bg-opacity-80 hover:bg-opacity-100 p-3 rounded-full transition-all duration-300 group shadow-lg z-20"
                            ...
                            <div className="py-12 px-8">
                                ...
                                {/* Quote */}
                                <blockquote className="text-lg sm:text-xl lg:text-2xl text-white leading-relaxed mb-8 max-w-3xl mx-auto">
                                    &ldquo;{testimonials[currentTestimonial].quote}&rdquo;
                                </blockquote>

                                {/* Quotation Marks */}
                                <div className="text-4xl sm:text-5xl lg:text-6xl text-yellow-400 font-serif">
                                    &ldquo;
                                </div>
                            </div>
                        </div>
