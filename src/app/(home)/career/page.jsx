                                    ...
                                    <div className="space-y-4">
                                            ...
                                            <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                                                {currentVacancy.location && (
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="font-medium">{currentVacancy.location}</span>
                                                    </div>
                                                )}
                                                {currentVacancy.department && (
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="font-medium">{currentVacancy.department}</span>
                                                    </div>
                                                )}
                                            </div>
                                        )}
                                        ...
                                        {currentVacancy.functionalArea && (
                                            <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="font-medium">{currentVacancy.functionalArea}</span>
                                                </div>
                                                {currentVacancy.reportingTo && (
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="font-medium">Reports to: {currentVacancy.reportingTo}</span>
                                                    </div>
                                                )}
                                            </div>
                                        )}
                                        ...
                                        {currentVacancy.qualification && (
                                            <div className="flex items-center text-sm text-gray-600">
                                                ...
                                                <span className="font-medium">{currentVacancy.qualification}</span>
                                            </div>
                                        )}
