          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Connect USB device to computer</span>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Install attendance software</span>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Enroll employee fingerprints</span>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-700">Start tracking attendance</span>
              </div>
            </div>
          </div>
