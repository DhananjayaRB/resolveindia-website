...
const GPSPage = () => {
  ...
  const workFromAnywhereRef = React.useRef(null);
  ...
  return (
    <div className="pt-20 text-sm">
      {/* Hero Section */}
      <section className="bg-white py-16" ref={heroRef}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 
                className="text-3xl lg:text-4xl font-bold text-[rgb(2,126,197)] mb-6"
              >
                Your Attendance - <aside className="text-gray-600">Look No Further -</aside> Resolved!
              </h1>
              <button 
                className="bg-[rgb(2,126,197)] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[rgb(1,100,150)] transition-colors"
              >
                GET IN TOUCH
              </button>
            </div>
      ...
      <section className="py-16 bg-white" ref={workFromAnywhereRef}>
      ...
      <section className="py-16 bg-white" ref={resolveRef}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div 
      ...
      <section className="py-16 bg-gray-50" ref={realTimeRef}>
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl lg:text-2xl font-bold text-[rgb(2,126,197)] mb-6">
                ...
                <div className="bg-[#F0F3F2]">
                  {plan.features.map((feature, featureIndex) => (
                    <div key={featureIndex} className="border-b border-[#E0E0E0] py-3 px-4 text-left">
                      <aside className="text-sm text-gray-700">{feature}</aside>
              </div>
                  ))}
                </div>
              </div>
          ...
          <div className="space-y-4">
            {faqData.map((faq, index) => (
              <div key={index} className="border border-gray-200 rounded-lg">
                ...
                >
                  <aside className="font-semibold text-[rgb(2,126,197)] text-sm">{faq.question}</aside>
                  {openFAQ === index ? (
